...
### 🔗 קישורים ומונחים באנגלית — כלל פרמוט (נקבע 8/7/2026)

> **אסור להטמיע URL או מחרוזת אנגלית ארוכה בתוך שורת טקסט עברית** — הערבוב RTL/LTR שובר את קריאות הטקסט.
> **חובה** לשים קישורים/מחרוזות אנגליות בשורה נפרדת בתוך code block:
>
> ✅ נכון:
> ```
> כנס לכתובת:
> github.com/Liders-CRM/Liders_CRM/pull/45
> ```
> ❌ לא נכון: כנס ל- `github.com/Liders-CRM/Liders_CRM/pull/45` ולחץ Merge.
>
> הכלל חל על: URLs, נתיבי קבצים, פקודות bash, שמות branch, כל מחרוזת אנגלית שמשבשת זרימת הטקסט העברי.
